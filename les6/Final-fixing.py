...
#je hebt geen zogenaamde "testfunctie" nodig, want alles in INPUT, je kan dus gewoon waardes invullen om te testen of het buiten/binnen een groep valt.
#Hiervoor heb je dus geen aparte functie nodig, omdat ik alles HANDMATIG test............. Daarom dat er nu nog steeds geen "testfunctie" is, en die gaat er ook niet komen.